...
(defprotocol  ILSPFeatureHandler
  ...
  (will-rename-files [this rename-files])
  (did-rename-files [this rename-files])
  (will-create-files [this create-files])
  (did-create-files [this create-files])
  (will-delete-files [this delete-files])
  (did-delete-files [this delete-files])
  (did-open-notebook-document [this notebook])
  (did-change-notebook-document [this notebook])
  (did-save-notebook-document [this notebook])
  (did-close-notebook-document [this notebook])
